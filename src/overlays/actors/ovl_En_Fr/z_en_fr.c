...
#define FLAGS (ACTOR_FLAG_ATTENTION_ENABLED | ACTOR_FLAG_FRIENDLY | ACTOR_FLAG_ALWAYSUPDATE | ACTOR_FLAG_25)
...
void EnFr_Init(Actor* thisx, PlayState* play) {
    ...
    if (this->actor.params == 0) {
        ...
        this->actor.flags &= ~(ACTOR_FLAG_ATTENTION_ENABLED | ACTOR_FLAG_ALWAYSUPDATE);
        this->actor.flags &= ~0;
