...
#define FLAGS (ACTOR_FLAG_ALWAYSUPDATE | ACTOR_FLAG_THROW_ONLY)
...
void EnNiw_Update(Actor* thisx, PlayState* play) {
    ...
    if (this->unk_2A8 != 0 && thisx->xyzDistToPlayerSq < SQ(dist) && !(player->stateFlags1 & PLAYER_STATE1_TAKING_DAMAGE ))
#else
